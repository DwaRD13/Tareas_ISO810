# Proyecto TSS - Tesorería de la Seguridad Social

Sistema para procesar archivos CSV de empleados, calcular descuentos de seguro y generar archivos de salida.
